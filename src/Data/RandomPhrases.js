const phrases = [
  ...
  {
    id: 8,
    frase: "Dream as if you will live forever. Live as if you will die today.",
    transcript:
  ...
  {
    id: 33,
    frase: "Success depends on a conscious effort to change your own destiny.",
    transcript:
...
export const getRandomPhrase = () => {
  let number = "";
  number = Math.floor(Math.random() * 41);
  return phrases[number].frase;
};
